...
public class ServerTest extends TestCase {
	...
	public void testApp() {
		...
		Quick.Protocol.SerialPort.QpSerialPortServerOptions options = new Quick.Protocol.SerialPort.QpSerialPortServerOptions();
		options.PortName = "COM2";
		options.Password = "HelloQP";
		options.ServerProgram = "QuickProtocol Server Test(Java)";

		Quick.Protocol.SerialPort.QpSerialPortServer server = new Quick.Protocol.SerialPort.QpSerialPortServer(options);
